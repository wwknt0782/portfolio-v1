		...
		<main className="grow mt-16 overflow-auto">
			<div className="mx-4 md:px-10 lg:px-20">
				...
				>
					...
					<p className="mt-8 ml-2">当サイトの作者の情報を掲載しています。</p>
				</div>
						...
						<div className="md:flex flex-row">
							...
							<div className="">
								...
								<div className="flex flex-row mt-3 relative">
									...
									<p className="pt-4.5 text-bold">Watanabe Kanta</p>
									<span className="absolute top-8 border-b-9 border-[var(--color-primary)]/40 w-100">
										{" "}
									</span>
								</div>
								<div className="flex flex-row items-center mt-3">
									<p className="w-35 text-xs text-center">生年月日</p>
									<p className="text-md">1998年 1月 22日 (27歳)</p>
								</div>
								<div className="flex flex-row items-center mt-1">
									<p className="w-35 text-xs text-center">メールアドレス</p>
									<p className="text-md">wwknt0782@gmail.com</p>
								</div>
								<div className="flex flex-row items-center mt-1">
									<p className="w-35 text-xs text-center">趣味・特技</p>
									<p className="text-md">イラスト，ゲーム(主にRPG)</p>
								</div>
							</div>
						</div>
						<div>
				...
				<div className="mt-30 relative">
					...
					<p className="absolute left-16 top-[14.5px] text-sm">Career</p>
					{/*本文----------------------------------------------------------*/}
				...
				<div className=" mt-20 relative">
					...
					<p className="absolute left-22 top-[14.5px] text-sm">Skills</p>
					{/*本文----------------------------------------------------------*/}
