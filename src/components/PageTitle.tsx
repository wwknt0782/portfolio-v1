    ...
    if (props.title === "profile") {
        return (
            <div>
                ...
                <h2 className="text-6xl relative">
                    ...
                    <span className="absolute top-11.5 left-2 border-6 w-87 text-[var(--color-primary)]/40">
                        {" "}
                    </span>
                </h2>
            </div>
        ...
        return (
            <div>
                ...
                <h2 className="text-6xl relative">
                    制作実績
                    <span className="absolute top-11.5 left-1 border-6 w-65 text-[var(--color-primary)]/40">
                        {" "}
                    </span>
                </h2>
            </div>
        ...
        return (
            <div>
                ...
                <h2 className="text-6xl relative">
                    お問い合わせ
                    <span className="absolute top-11.5 left-1 border-6 w-95 text-[var(--color-primary)]/40">
                        {" "}
                    </span>
                </h2>
            </div>
