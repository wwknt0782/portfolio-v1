...
export default function ContactMain() {
	...
	const onSubmit: SubmitHandler<z.infer<typeof FormSchema>> = (e) => {
		if (errors) {
			console.log(errors);
		}
	};
		...
		<div>
			...
			<main className="grow mt-16 overflow-auto">
				<div className="mx-4 md:px-10 lg:px-20">
					...
					<Form action="/confirm" onSubmit={handleSubmit(onSubmit)} noValidate>
						<div>
							{errors && (
								<p className="text-red-600 pb-4">入力項目に誤りがあります。</p>
							)}
						</div>
